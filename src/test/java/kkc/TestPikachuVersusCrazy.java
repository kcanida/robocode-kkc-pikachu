package kkc;
   ...
   * This test simply verifies that Pikachu always beats Crazy.
   * 
   ...
   */
  public class TestPikachuVersusCrazy extends RobotTestBed {

    /**
     * Specifies that Crazy and Pikachu are to be matched up in this test case.
     * @return The comma-delimited list of robots in this match.
     */
    @Override
    public String getRobotNames() {
      return "sample.Crazy,kkc.Pikachu";
    }
    ...
    /**
     * The actual test, which asserts that Pikachu has won every round against Crazy.
