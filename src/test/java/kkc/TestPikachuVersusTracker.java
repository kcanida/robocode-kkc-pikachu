...
import robocode.control.events.TurnEndedEvent;
   ...
   * This test simply verifies that Pikachu always beats Tracker.
   * 
  ...
  public class TestPikachuVersusTracker extends RobotTestBed {
    ...
    public String getRobotNames() {
      return "sample.Tracker,kkc.Pikachu";
    }
    ...
    /**
     * The actual test, which asserts that Pikachu has won every round against Tracker.
