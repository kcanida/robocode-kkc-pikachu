package kkc;
   ...
   * This test simply verifies that Pikachu always beats RamFire.
   * 
   ...
   */
  public class TestPikachuVersusRamFire extends RobotTestBed {
    ...
    /**
     * The actual test, which asserts that Pikachu has won every round against RamFire.
