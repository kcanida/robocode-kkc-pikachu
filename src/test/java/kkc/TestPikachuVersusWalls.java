...
import robocode.control.events.TurnEndedEvent;
   ...
   * This test simply verifies that Pikachu always beats Walls.
   * 
   ...
   */
  public class TestPikachuVersusWalls extends RobotTestBed {
    ...
    /**
     * The actual test, which asserts that Pikachu has won every round against Walls.
