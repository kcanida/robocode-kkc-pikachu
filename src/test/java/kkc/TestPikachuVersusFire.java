package kkc;
   ...
   * This test simply verifies that Pikachu always beats Fire.
   * 
   ...
   */
  public class TestPikachuVersusFire extends RobotTestBed {

    /**
     * Specifies that Fire and Pikachu are to be matched up in this test case.
     * @return The comma-delimited list of robots in this match.
     */
    @Override
    public String getRobotNames() {
      return "sample.Fire,kkc.Pikachu";
    }
    ...
    /**
     * The actual test, which asserts that Pikachu has won every round against Fire.
