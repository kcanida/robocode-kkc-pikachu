package kkc;
   ...
   * This test simply verifies that Pikachu always beats SittingDuck.
   * 
   ...
   */
  public class TestPikachuVersusSittingDuck extends RobotTestBed {

    /**
     * Specifies that SittingDuck and Pikachu are to be matched up in this test case.
     * @return The comma-delimited list of robots in this match.
     */
    @Override
    public String getRobotNames() {
      return "sample.SittingDuck,kkc.Pikachu";
    }
    ...
    /**
     * The actual test, which asserts that Pikachu has won every round against SittingDuck.
