package kkc;
   ...
   * This test simply verifies that Pikachu always beats Corners.
   * 
   ...
   */
  public class TestPikachuVersusCorners extends RobotTestBed {

    /**
     * Specifies that Corners and Pikachu are to be matched up in this test case.
     * @return The comma-delimited list of robots in this match.
     */
    @Override
    public String getRobotNames() {
      return "sample.Corners,kkc.Pikachu";
    }
    ...
    /**
     * The actual test, which asserts that Pikachu has won every round against Corners.
